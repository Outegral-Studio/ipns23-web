...
class Game extends React.Component {
    constructor(props) {
      ...
      resetGame() {
          ...
          this.ball = new Ball(this.canvasWidth / 2, 50, this.canvasHeight / 45, this.canvasWidth, this.canvasHeight);
          this.hole = {x: this.canvasWidth / 2, y: this.canvasHeight*6/7, radius: 50};

          this.obstacles = [
              new Obstacle(this.canvasWidth * 5 / 7  - 80, (this.canvasHeight*6/7) / 3.8, 200, 38, '分流去其他系'),
              new Obstacle(this.canvasWidth * 2 / 9 - 80, (this.canvasHeight*6/7) / 2, 200, 38, '高估自己實力'),
              new Obstacle(this.canvasWidth * 3 / 7 - 80, (this.canvasHeight*6/7) * 3 / 4, 200, 38, '放棄夢想'),
          ];

          if (this.canvasWidth > 1300){
            this.obstacles.push(new Obstacle(this.canvasWidth * 4 / 7 - 80, (this.canvasHeight*6/7)* 2.1 / 4, 200, 38, '脊椎側彎'))
          }
