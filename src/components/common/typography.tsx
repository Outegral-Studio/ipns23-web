...
function H4({
	...
	return <Comp className={cn("mt-4 scroll-m-20 text-lg font-semibold tracking-tight [&+p]:!mt-2", className)} {...props} />;
}
...
function P({
	...
	return <Comp className={cn("leading-loose [&:not(:first-child)]:mt-4 [word-break:break-word]", className)} {...props} />;
}
...
function Blockquote({
	...
	return <Comp className={cn("border-[color-mix(in_oklch,_var(--primary),_white_10%)] border-l-4 pl-6 [&:not(:first-child)]:mt-4", className)} {...props} />;
}
